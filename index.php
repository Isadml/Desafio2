                ...
                <nav class="navbar">
                    ...
                    <div class="collapse navbar-collapse" id="menu">
                        <nav class="navbar-nav">
                            <a href="Vistas/Otras/Buscar_Nombre.php" class="nav-link deeppink">Buscar por nombre</a>
                            <a href="Vistas/Otras/Buscar_Plataforma.php" class="nav-link deeppink">Buscar por plataformas</a>
                            <a href="Vistas/Otras/Buscar_Genero.php" class="nav-link deeppink">Buscar por géneros</a>
                        </nav>
                    </div>
                </nav>
                ...
                <nav class="navbar">
                    ...
                    <div class="collapse navbar-collapse" id="menu2">
                        <nav class="navbar-nav">
                            ...
                            <a href="Vistas/Usuarios_Registrados/Add_Juego.php" class="nav-link deeppink">Añadir juego</a>
                            <a href="Vistas/Usuarios_Registrados/Add_Review.php" class="nav-link deeppink">Añadir reseña</a>
                        </nav>
                    </div>
                </nav>
                ...
                <nav class="navbar">
                    ...
                    <div class="collapse navbar-collapse" id="menu3">
                        <nav class="navbar-nav">
                            ...
                            <a href="Vistas/Administrador/Administrar_Reviews.php" class="nav-link deeppink">Administrar reseñas</a>
                            <a href="Vistas/Administrador/Administrar_Usuarios.php" class="nav-link deeppink">Administrar usuarios</a>
                        </nav>
                    </div>
                </nav>
